 ...
 */
public class LinearRecyclerViewCardAdapter extends RecyclerView.Adapter<LinearRecyclerViewCardAdapter.ViewHolder> {

    private static final String TAG = "LinearRecyclerViewCardAdapter";
    private Context mContext;
    private List<BrandCardData> brandCardDatas;

    // Provide a suitable constructor (depends on the kind of dataset)
    public LinearRecyclerViewCardAdapter(Context context, List<BrandCardData> brandCardDatas) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        final View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.linear_card_view_detail, parent, false);
